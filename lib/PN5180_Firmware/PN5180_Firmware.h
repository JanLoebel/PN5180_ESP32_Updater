...
#define PN5180_DL_OPCODE_DL_GETDIEID 0xF4		 /** <This command returns the die ID.							*/
...
{
public:
	PN5180_Firmware(uint8_t Reset, uint8_t Busy, uint8_t Req, uint8_t Nss, uint8_t Mosi, uint8_t Miso, uint8_t Sck);
